        ...
        <div className="w-full xl:w-2/3">
          ...
          <div className="flex flex-col lg:flex-row gap-4">
            ...
            <div className="bg-hopeSky py-6 p-4 rounded-md flex-1 flex gap-4">
              <div className="w-1/3">
                <Image 
                  src="https://images.pexels.com/photos/2182970/pexels-photo-2182970.jpeg?auto=compress&cs=tinysrgd&w=1200" 
              ...
              <div className="w-2/3 flex flex-col justify-between gap-4">
                <h1 className="text-xl font-semibold">Leonard Da Silva</h1>
                ...
                <div className="flex items-center justify-between gap-2 flex-wrap text-xs font-medium">
                  ...
                  <div className="w-full md:w-1/3 lg:w-full 2xl:w-1/3 flex items-center gap-2">
                    ...
                    <span className="">leonard@user.com</span>
                  </div>
                  <div className="w-full md:w-1/3 lg:w-full 2xl:w-1/3 flex items-center gap-2">
        ...
        <div className="w-full xl:w-1/3 flex flex-col gap-4">
          <div className="bg-white rounded-md p-4">
            ...
            <div className="mt-4 flex gap-4 flex-wrap text-xs text-gray-500">
              <Link className="p-3 rounded-md bg-hopeSkyLight" href="/">Teacher&apos;s Classes</Link>
              <Link className="p-3 rounded-md bg-hopePurpleLight" href="/">Teacher&apos;s Students</Link>
              <Link className="p-3 rounded-md bg-hopeYellowLight" href="/">Teacher&apos;s Lessons</Link>
              <Link className="p-3 rounded-md bg-pink-50" href="/">Teacher&apos;s Lessons</Link>
              <Link className="p-3 rounded-md bg-hopeSkyLight" href="/">Teacher&apos;s Assignments</Link>
            </div>
          </div>
          <Performance />
          <Announcements />
...
export default SingleTeacherViewPage